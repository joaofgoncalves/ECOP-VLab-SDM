...
- The [Docker](https://www.docker.com/) container used to run IRIS SDM ([here](https://hub.docker.com/r/jfgoncalves/r-biomod2/)) currently runs R version 3.5.0 (2018-04-23) -- "Joy in Playing" / Platform: x86_64-pc-linux-gnu (64-bit);

- This container currently enables running [Maxent models](https://github.com/mrmaxent/Maxent), with maxent.jar located in the ./output folder (by default). For this reason, maxent.jar path should not be changed.

### Programming language

R (mainly including the _raster_ and _biomod2_ packages, along with their dependencies) and Linux bash.
